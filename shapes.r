...
cube <- function(p = 3){
	structure(
	  list(points = cube.vertices(p), edges = cube.wires(p)),
	  class = "geozoo"
	)
}
...
##Flat Torus
torus.flat<-function(p=even,n=10000){
	p <- floor(p / 2)
